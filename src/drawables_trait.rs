...
pub fn draw_ui_bg(canvas:&mut Canvas, ctx:&mut ggez::Context)->ggez::GameResult{
    let game_space = graphics::Rect::new(GAME_SCREENW, 0.0, crate::UIX, crate::GAME_SCREENY+crate::UIY);
    ...
    let game_space_b = graphics::Rect::new(0.0, crate::GAME_SCREENY, crate::GAME_SCREENW, crate::UIY);
...
pub trait MakeDrawable{
    fn draw_object(&self,_canvas:&mut Canvas,_ctx:&mut ggez::Context,_screendata:&ScreenInfo)->ggez::GameResult{
        Ok(())
    }
}
...
impl MakeDrawable for super::MainState {
   fn draw_object(&self,canvas:&mut Canvas,ctx:&mut ggez::Context,_screendata:&ScreenInfo)->ggez::GameResult {
...
impl MakeDrawable for super::game_state::player::Player{
    fn draw_object(&self,canvas:&mut Canvas,ctx:&mut ggez::Context,screen:&ScreenInfo)->ggez::GameResult {
